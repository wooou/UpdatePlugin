 ...
 *
 * <ol>
 *     <li>当通过更新api检查到有新版本需要被更新，且当{@link #isShowUpdateDialog(UpdateInterface)}返回true时：触发使用创建器{@link DialogCreator}创建界面通知</li>
...
public interface UpdateStrategy {
     ...
     * @see DialogCreator
     */
    boolean isShowUpdateDialog(UpdateInterface update);
